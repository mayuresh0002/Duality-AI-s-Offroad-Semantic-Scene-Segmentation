"""
Off-Road Semantic Segmentation Training Script
Trains a segmentation head on top of DINOv2 backbone for terrain classification
"""
...
def main():
    ...
    print(f"Segmentation head created with {sum(p.numel() for p in classifier.parameters())} parameters")
    ...
    print("\nSaving training curves and metrics...")
